...
DailyPanchang DailyPanchangFromJson(String str) =>
    DailyPanchang.fromJson(json.decode(str));

String DailyPanchangToJson(DailyPanchang data) => json.encode(data.toJson());
